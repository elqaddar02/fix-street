                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="lg:w-1/2 mb-6 lg:mb-0 lg:pr-6">
                            <img src="{{ $report->image ? asset('storage/' . $report->image) : asset('assets/report-placeholder.svg') }}"
                                 alt="{{ $report->title }}"
                                ...
                                <div class="mt-8">
                                    ...
                                    @auth
                                        <form method="POST" action="{{ route('reports.comments.store', $report->id) }}" class="space-y-3">
                                            ...
                                            <button type="submit" class="gov-button gov-secondary px-4 py-2">Post Comment</button>
                                        </form>
                                    @else
                                        <div class="p-4 border border-red-100 text-red-700 rounded">
                                            <p>You must <a href="{{ route('login') }}" class="font-semibold underline">log in</a> to comment.</p>
                                        </div>
                                    @endauth
                                </div>
                            </div>
